export const ClericList = {
    createWater:{
        spellName: "Create Water",
        level: 0
    },
    cureMinorWounds:{
        spellName: "Cure Minor Wounds",
        level: 0
    },
    detectMagic:{
    ...
    inflictMinorWounds:{
        spellName: "Inflict Minor Wounds",
        level: 0
    },
    light:{
        spellName: "Light",
    ...
    protectionFromChaosEvilGoodLaw:{
    ...
    inflictSeriousWounds:{
        spellName: "Inflict Serious Wounds",
        level: 3
    },
    invisibilityPurge:{
        spellName: "Invisibility Purge",
        level: 3
    },
    locateObject:{
    ...
    magicCircleAgainstChaosEvilGoodLaw:{
        spellName: "Magic Circle Against Chaos/ Evil/ Good/ Law",
        level: 3
    },
    magicVestment:{
        spellName: "Magic Vestment",
        level: 3
    },
    meldIntoStone:{
        spellName: "Melt Into Stone",
        level: 3
    },
    obscureObject:{
    ...
    removeBlindnessDeafness:{
        spellName: "Remove Blindness/ Deafness",
        level: 3
    },
    removeCurse:{
    ...
    giantVermin:{
        spellName: "Giant Vermin",
        level: 4
    },
    imbueWithSpellAbility:{
        spellName: "Imbue With Spell Ability",
        level: 4
    },
    inflictCriticalWounds:{
        spellName: "Inflict Critical Wounds",
        level: 4
    },
    magicWeaponGreater:{
        spellName: "Magic Weapon, Greater",
        level: 4
    },
    neutralizePoison:{
    ...
    dispelChaosEvilGoodLaw:{
        spellName: "Dispel Chaos/ Evil/ Good/ Law",
        level: 5
    },
    disruptingWeapon:{
        spellName: "Disrupting Weapon",
        level: 5
    },
    flameStrike:{
    ...
    inflictLightWoundsMass:{
        spellName: "Inflict Light Wounds, Mass",
        level: 5
    },
    insectPlague:{
    ...
    slayLiving:{
        spellName: "Slay Living",
        level: 5
    },
    spellResistance:{
        spellName: "Spell Resistance",
        level: 5
    },
    summonMonsterV:{
    ...
    glyphOfWardingGreater:{
        spellName: "Glyph of Warding, Greater",
        level: 6
    },
    harm:{
        spellName: "Harm",
    ...
    inflictModerateWoundsMass:{
        spellName: "Inflict Moderate Wounds, Mass",
        level: 6
    },
    owlsWisdomMass:{
